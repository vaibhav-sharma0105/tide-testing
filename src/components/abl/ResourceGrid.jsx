  ...
  if (!resources.length) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center gap-4">
        ...
        <p className="font-display text-xl font-semibold text-tide-text">No resources match your filters</p>
        <p className="text-sm font-body text-tide-muted">Try adjusting or clearing your filters</p>
      </div>
    )
  }
